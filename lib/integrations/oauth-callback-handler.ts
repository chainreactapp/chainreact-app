    ...
    if (currentIntegration) {
      try {
        const healthIntegration: HealthIntegration = {
          ...
          provider,
          health_check_status: currentIntegration.health_check_status as HealthIntegration['health_check_status'],
          last_notification_milestone: currentIntegration.last_notification_milestone as HealthIntegration['last_notification_milestone'],
