...
| 2026-05-05 | 5 files: check-integration-columns.mjs (Wave A schema audit, ran in-session — column-existence check for scope_validation_status / granted_scopes / last_scope_check / credentials on integrations), inspect-id-default.mjs, inspect-workflow-shape.mjs, verify-sse-lineage-postdeploy.mjs, verify-sse-root-column.mjs (4 with RAN headers from 2026-05-04). inspect-v1-v2-distribution.mjs was kept — no RAN header, author unconfirmed. |
